...
public class LoginActivity extends AppCompatActivity {
    ...
    FirebaseAuthException auth;
    private String userUID;
    FirebaseAuthException.AuthStateListener authListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auth = FirebaseAuthException.getInstance();
        //success or error message after login
        authListener = new FirebaseAuthException.AuthStateListener(){

            @Override
            public void onAuthStateChanged(@NonNull FirebaseAuthException firebaseAuth){
                FirebaseUser user = firebaseAuth.getCurrentUser();
                if(user!=null){//Login success
                    android.util.Log.d("onAuthStateChanged", "Login: " + user.getUid());
                    userUID = user.getUid();
                }else{//Logout or Login failed
                    android.util.Log.d("onAuthStateChanged", "Logout");
                }
            }
        };//end of authListener
    }//end of onCreate
    ...
    public void login(View v){
        ...
        android.util.Log.d("AUTH", email+"/"+password);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(!task.isSuccessful()){
                            android.util.Log.d("onComplete", "Login failed");
                            //register new user
